...
export default {
	...
	"Autocomplete candidate sources desc": "Choose which kinds of candidates can appear in the autocomplete dropdown.",
	...
	"Search history source file desc": "Show file-name matches from indexed files in the autocomplete list.",
	"Search history source alias": "Alias candidates",
	"Search history source alias desc": "Show frontmatter alias matches in the autocomplete list.",
	"Search history source heading": "Heading candidates",
	"Search history source heading desc": "Show heading matches from indexed files in the autocomplete list.",
	"Search history source path": "Path candidates",
	"Search history source path desc": "Show full-path matches in the autocomplete list.",
	"Search history source recent": "Recent file candidates",
	"Search history source recent desc": "Show recently opened files in the autocomplete list when their names match.",
	...
	"Chinese word blacklist desc": `Activates only if the Chinese Patch is enabled. This excludes some meaningless Chinese words like "闁?, "闁圭鍋撳ù?, "閻忓繒鏅? listed in 'stop-words-zh.txt', improving search efficiency and speed. More details are listed in "English word blacklist" option`,
	...
	"hybridModal.weeklyTokenLimit.desc": "Maximum tokens to consume per week (Mon闁炽儲褰巙n). Set to 0 for unlimited.",

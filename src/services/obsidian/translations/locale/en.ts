...
export default {
	...
	"Search history suggestions": "Search history suggestions",
	"Search history suggestions desc": "Show the history candidate popup while typing. Only confirmed searches are recorded.",
	"Search history ghost completion": "Search history ghost completion",
	"Search history ghost completion desc": "Show the best matched history suffix as a ghost completion and accept it with Tab. Only confirmed searches are recorded.",

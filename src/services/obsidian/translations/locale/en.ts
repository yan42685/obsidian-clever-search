...
export default {
	...
	"hybridModal.highPerformanceMode": "Auto high performance mode",
	"hybridModal.highPerformanceMode.desc": "Allow the plugin to asynchronously preload all indexable files into memory when the total indexable size stays within the threshold, so lexical and hybrid queries can read shared snapshots faster.",
	"hybridModal.highPerformanceMode.on": "On",
	"hybridModal.highPerformanceMode.off": "Off",
	"hybridModal.highPerformanceThreshold": "Auto enable threshold (MB)",
	"hybridModal.highPerformanceThreshold.desc": "If the total indexable file size is at or below this value, high performance mode preloads all files into memory. Set 0 to disable automatic activation.",
	"hybridModal.highPerformanceMode.notice": "High performance mode asynchronously preloads all files into memory to speed up queries, and prefers shared snapshots to keep reads consistent.",
	"hybridModal.highPerformanceMode.total": "Total indexable file size",
	"hybridModal.highPerformanceMode.state": "Current state",
	"hybridModal.highPerformanceMode.state.active": "Active, preloading in-memory snapshots",
	"hybridModal.highPerformanceMode.state.inactive": "Inactive, current total size is above the threshold",
	"hybridModal.highPerformanceMode.state.disabled": "Disabled",
	...
	"File search backend desc":
		"Coverage Lexical is the default lexical engine and the main optimization path. MiniSearch remains the conservative fallback.",
	"fileSearchBackend.minisearch": "MiniSearch (fallback)",
	"fileSearchBackend.coverageLexical": "Coverage Lexical (default)",

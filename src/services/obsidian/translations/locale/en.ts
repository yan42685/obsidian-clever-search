...
export default {
	...
	"hybridModal.vectorCompression": "Vector precision",
	"hybridModal.vectorCompression.desc": "Controls how much embedding precision is retained for semantic ranking. Changing this requires rebuilding the hybrid index.",
	"hybridModal.vectorCompression.int8": "Int8 only (fastest, smallest)",
	"hybridModal.vectorCompression.float16": "Int8 + Float16 rerank (more accurate)",

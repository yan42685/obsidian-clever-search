...
export default {
	...
	"hybridModal.minIncrementalEmbedInterval.desc": "Minimum minutes between incremental embedding retries for the same file. Structure repair still runs immediately; only vector refill is delayed.",
	"hybridModal.failedEmbeddingRetryInterval": "Failed embedding retry interval",
	"hybridModal.failedEmbeddingRetryInterval.desc": "How many minutes to wait before automatically retrying embedding requests that already exhausted in-call retries during this session.",
	"hybridModal.failedEmbeddingStatus.summary": "Failed embedding files in this session",
	...
	"hybridModal.failedEmbeddingStatus.nextRetry": "Next auto retry",
	"hybridModal.failedEmbeddingStatus.soon": "within 1 minute",
	...
	"hybridModal.deferredEmbeddingStatus.nextResume": "Earliest vector refill",
	"hybridModal.failedEmbeddingReason.missing_api_key": "Missing API key",
	"hybridModal.failedEmbeddingReason.weekly_token_limit": "Weekly token limit exceeded",
	"hybridModal.failedEmbeddingReason.quota_exhausted": "Provider quota exhausted",
	...
	"hybridModal.autoShowMixedSearchResults.desc": "When hybrid search is enabled and the service is available, if lexical results are 0 in normal vault search and the query length is at least 3, automatically show hybrid search results. The first trigger is immediate, then repeated zero-result queries are trailing-debounced by 500 ms. After hybrid results are shown, the modal still remains in lexical search mode.",

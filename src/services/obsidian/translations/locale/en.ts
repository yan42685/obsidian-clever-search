...
export default {
	...
	"File search backend desc":
		"Coverage Lexical is the default lexical engine and the main optimization path. MiniSearch remains the conservative fallback, while the older BM25 backends are retained for compatibility and comparison.",
	"fileSearchBackend.minisearch": "MiniSearch (fallback)",
	"fileSearchBackend.customBm25": "Custom BM25 (legacy)",
	"fileSearchBackend.passageBm25": "Passage BM25 (legacy experimental)",

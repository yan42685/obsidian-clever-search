...
export default {
	...
	"hybridModal.embeddingModel.descPrefix": "Qwen is recommended because its embedding quality is clearly better. API key spending and limits cannot be controlled by the plugin cloud side. This plugin is not responsible for massive token or fee consumption caused by API key leakage, configuration mistakes, provider billing changes, or ",
	...
	"hybridModal.apiDomain.desc": "Provider API domain. Leave the default value unless you use a compatible proxy endpoint.",

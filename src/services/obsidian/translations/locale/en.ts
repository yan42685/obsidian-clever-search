...
export default {
	...
	"hybridModal.failedEmbeddingRetryInterval.desc": "How long to wait before automatically retrying embedding requests that already exhausted in-call retries during this session.",

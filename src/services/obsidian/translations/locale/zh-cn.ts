export default {
	...
	"hybridModal.autoShowResultsWhenLexicalEmpty.desc":
		"当开启 hybrid 搜索且服务可用时，在普通库内搜索中，如果词法搜索结果为 0，且查询长度至少为 3，则自动展示 hybrid 结果。第一次触发会立即执行，之后连续出现 0 结果时会以 500 ms 的 trailing debounce 展示最后一次对应的 hybrid 结果。展示 hybrid 结果后，搜索框仍然处于 lexical 搜索模式。",
	...
	"hybridModal.minIncrementalEmbedInterval.desc": "\u540c\u4e00\u6587\u4ef6\u518d\u6b21\u5c1d\u8bd5\u589e\u91cf embedding \u4e4b\u524d\u81f3\u5c11\u7b49\u5f85\u591a\u5c11\u5206\u949f\u3002\u7ed3\u6784\u4fee\u590d\u4ecd\u4f1a\u7acb\u5373\u6267\u884c\uff0c\u53ea\u662f\u5411\u91cf\u8865\u5168\u4f1a\u5ef6\u540e\u3002",
	"hybridModal.failedEmbeddingRetryInterval": "\u5931\u8d25 Embedding \u81ea\u52a8\u91cd\u8bd5\u95f4\u9694",
	"hybridModal.failedEmbeddingRetryInterval.desc": "\u5355\u6b21 session \u5185\uff0c\u5df2\u7ecf\u8017\u5c3d\u8c03\u7528\u5185\u91cd\u8bd5\u6b21\u6570\u7684 embedding \u5931\u8d25\uff0c\u9694\u591a\u5c11\u5206\u949f\u81ea\u52a8\u518d\u8bd5\u4e00\u6b21\u3002",
	"hybridModal.failedEmbeddingStatus.summary": "\u672c\u6b21 session \u5185 Embedding \u5931\u8d25\u6587\u4ef6",
	...
	"hybridModal.failedEmbeddingStatus.nextRetry": "\u4e0b\u6b21\u81ea\u52a8\u91cd\u8bd5",
	"hybridModal.failedEmbeddingStatus.soon": "1 \u5206\u949f\u5185",
	"hybridModal.deferredEmbeddingStatus.summary": "\u56e0\u6700\u5c0f\u95f4\u9694\u800c\u5ef6\u540e\u7684\u589e\u91cf Embedding \u6587\u4ef6",
	"hybridModal.deferredEmbeddingStatus.none": "\u5f53\u524d\u6ca1\u6709\u6587\u4ef6\u5728\u7b49\u5f85\u6700\u5c0f\u589e\u91cf Embedding \u95f4\u9694\u3002",
	"hybridModal.deferredEmbeddingStatus.nextResume": "\u6700\u65e9\u8865\u5168\u5411\u91cf\u65f6\u95f4",
	"hybridModal.failedEmbeddingReason.missing_api_key": "\u7f3a\u5c11 API Key",
	"hybridModal.failedEmbeddingReason.weekly_token_limit": "\u8d85\u51fa\u672c\u5468 token \u9650\u989d",
	"hybridModal.failedEmbeddingReason.quota_exhausted": "\u63d0\u4f9b\u65b9 quota \u8017\u5c3d",
	...
	"hybridModal.autoShowMixedSearchResults.desc": "\u5f53\u5f00\u542f\u6df7\u5408\u641c\u7d22\u4e14\u670d\u52a1\u53ef\u7528\u65f6\uff0c\u5982\u679c\u666e\u901a vault \u641c\u7d22\u4e2d lexical \u7ed3\u679c\u4e3a 0\uff0c\u4e14\u67e5\u8be2\u957f\u5ea6\u81f3\u5c11\u4e3a 3\uff0c\u5219\u81ea\u52a8\u5c55\u793a\u6df7\u5408\u641c\u7d22\u7ed3\u679c\u3002\u7b2c\u4e00\u6b21\u4f1a\u7acb\u5373\u89e6\u53d1\uff0c\u540e\u7eed\u8fde\u7eed\u7684 0 \u7ed3\u679c\u67e5\u8be2\u4f1a\u4f7f\u7528 500 ms \u7684 trailing debounce\u3002\u5c55\u793a\u6df7\u5408\u7ed3\u679c\u540e\uff0cmodal \u4ecd\u7136\u4fdd\u6301\u5728 lexical \u641c\u7d22\u6a21\u5f0f\u3002",

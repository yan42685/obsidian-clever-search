export default {
	...
	"Search history suggestions": "历史候选框",
	"Search history suggestions desc": "输入时显示历史搜索候选框。只有确认过的搜索才会被记录。",
	"Search history ghost completion": "影子补全",
	"Search history ghost completion desc": "显示最佳历史记录的影子补全，并可用 Tab 接受补全。只有确认过的搜索才会被记录。",

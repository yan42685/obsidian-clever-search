...
describe("getTruncatedContext", () => {
	...
	test("Actual truncation at the end of the document", () => {
		const lines = Array.from(
			...
			(_, i) =>
				new Line(
					"3333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333",
					i,
				),
		);
